...
const AppBar = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      await axios.post(
        "http://13.203.101.140//auth/send-otp",
        {
          email,
        },
        {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      await axios.post(
        "http://13.203.101.140//auth/verify-otp",
        {
          email,
          otp,
        },
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("http://13.203.101.140//auth/login", {
        email,
        password,
      });
  ...
  const register = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://13.203.101.140//auth/register", {
        email,
        password,
        username,
      });
  ...
  const handleAdmin = async (userId) => {
    try {
      const res = await axios.get("http://13.203.101.140//auth/user-role", {
        params: { userId },
        headers: {
