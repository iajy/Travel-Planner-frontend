...
const Ticket = () => {
  ...
  const fetchIataCode = async (locationName) => {
    try {
      const response = await axios.get(
        "https://13.203.101.140:8080/api/flights/iata",
  ...
  const fetchLocationName = async (iataCode) => {
    try {
      const response = await axios.get(
        "https://13.203.101.140:8080/api/flights/location",
        { params: { iataCode } ,
          headers: {
            Authorization: `Bearer ${localStorage.getItem("jwtToken")}`,
            "Content-Type": "application/json",
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await axios.get("https://13.203.101.140:8080/api/flights", {
        params: {
          origin: originCode,
  ...
  const handleBooking = async (flight) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://13.203.101.140:8080/api/itineraries/${itineraryId}/booking`,
        bookingRequest,
        {
          headers: {
